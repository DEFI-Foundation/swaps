...
contract USDTPool is MetalSwapPoolAbstract  {
    ...
    function removeLiquidity(uint256 _amount, uint256 _tokenId) public nonReentrant override returns (uint256 liquidityToWithdraw){
        ...
        require(liquidityToWithdraw > 0, "Error: amount of USDT to withdraw is too small");
        require(liquidityToWithdraw <= _positions[_tokenId].liquidity, "Error: user is asking to withdraw more than provided");
        require(liquidityToWithdraw > penalities, "Error: your penalities are higher than the USDT to withdraw, please wait longer");
