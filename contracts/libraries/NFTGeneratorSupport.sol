...
library NFTGeneratorSupport {
    ...
    function generateDefinitions(string memory color1, string memory color2)
        internal
        pure
        returns (string memory definitionsSVG)
    {
        return
            string(
                abi.encodePacked(
    ...
    function buildBorder(string memory borderColor)
        internal
        pure
        returns (string memory borderSVG)
    {
        return
            string(
                abi.encodePacked(
    ...
    function buildTokenId(uint256 tokenId)
        internal
        pure
        returns (string memory tokenIdSVG)
    {
        return
            string(
                abi.encodePacked(
